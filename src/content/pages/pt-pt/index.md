---
_schema: default
title: Os Prémios Stevie® para Mulheres no Mundo dos Negócios
description: ''
pageSections:
  - _component: page-sections/heroes/hero-calendar
    ...
    subheading: As inscrições já estão abertas
    heading: 23.ª Edição dos Prémios Stevie® para Mulheres no Mundo dos Negócios
    description: |-
  ...
  - _component: page-sections/features/split-list-form
    subheading: Indique empresas geridas por mulheres, empreendedoras e muito mais
    heading: Categorias dos prémios
    description: |-
      Há mais de 20 anos que os Prémios Stevie® para Mulheres no Mundo dos Negócios têm vindo a destacar mulheres e organizações de todos os tipos e dimensões, em todo o mundo, que são detidas ou lideradas por mulheres: grandes e pequenas, públicas e privadas, com ou sem fins lucrativos. A edição de 2025 atraiu mais de 1.500 nomeações de 48 países.

      Empresárias, executivas, funcionárias e as organizações que dirigem, em todo o mundo, são elegíveis para serem nomeadas. Com mais de 200 categorias que abrangem uma vasta gama de realizações no local de trabalho, pode submeter nomeações que mostrem o seu impacto e valores únicos. O programa de 2026 introduz novas categorias que reconhecem realizações em inteligência artificial e tecnologia.
    list:
      _component: building-blocks/core-elements/list
      items:
        - text: Categorias de conquistas
          iconName: four-pointed-star
          iconColor: brand
        - text: Conquistas nas categorias de Comunicação, Marketing ou Relações Públicas
          iconName: four-pointed-star
          iconColor: brand
        - text: Inteligência Artificial (IA) e Categorias Tecnológicas (Novidades para 2026)
          iconName: four-pointed-star
          iconColor: brand
        - text: Empresa/Organização (de propriedade ou liderada por mulheres) – Categorias dos prémios
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorias dos Prémios Individuais para Mulheres
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorias dos Prémios «Media» (Desenvolvidos para/por Mulheres)
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorias dos Prémios para Novos Produtos e Serviços (Desenvolvidos para/por Mulheres)
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorias de redes sociais
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorias de sustentabilidade
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorias de Liderança de Pensamento
          iconName: four-pointed-star
          iconColor: brand
      listType: icon
      direction: vertical
  ...
  - _component: page-sections/features/feature-logo-scroller
    heading: Vencedoras anteriores dos Prémios Stevie® para Mulheres no Mundo dos Negócios
    description: 'Todos os anos, são distinguidas mulheres proprietárias de pequenas empresas e empreendedoras, juntamente com mulheres executivas de empresas globais como a IBM, a Mastercard e a Microsoft. Entre as vencedoras de edições anteriores contam-se:'
    logos:
    ...
    backgroundColor: base
  - _component: page-sections/features/split-list-form
    subheading: Os Prémios Stevie® para Mulheres no Mundo dos Negócios
    heading: ARTIGOS EM DESTAQUE
    description: ''
    list:
      ...
      stories:
        - image:
          ...
          title: Anunciadas as vencedoras da 22.ª edição dos Prémios Stevie® para Mulheres no Mundo dos Negócios
        ...
        - image:
          ...
          title: Anunciados os finalistas dos Prémios SheShapesAI da Persistent na 22.ª edição dos Prémios Stevie® para Mulheres no Mundo dos Negócios
        ...
        - image:
          ...
          title: Inscreva-se nos webinars Women|Future de 2026
  ...
  - _component: page-sections/features/grid-videos
    heading: O que significa ganhar um Prémio Stevie para os nossos vencedores de 2025
    videos:
      - youtubeId: UqX5Q9pE6io
        title: 'A marca Distruptor vence os Prémios Stevie® 2025 para Mulheres no Mundo dos Negócios '
      - youtubeId: wvSEt0yvIqs
        title: A Green Panther Skincare vence os Prémios Stevie® 2025 para Mulheres no Mundo dos Negócios
      - youtubeId: fS5Q7wiWcJs
        title: O Clearpath Learning Group vence os Prémios Stevie® 2025 para Mulheres no Mundo dos Negócios
    colorScheme: light
    backgroundColor: base
  - _component: page-sections/features/grid-testimonials
    heading: Testemunhos dos vencedores
    testimonials:
  ...
  - _component: page-sections/carousels/card-carousel
    heading: Explore outros concursos dos Prémios Stevie®
    description: Seja qual for o motivo pelo qual a sua organização pretende ser reconhecida, existe um programa e uma categoria dos Stevie Awards adequados. Desde profissionais individuais e equipas até departamentos e realizações a nível de toda a empresa, cada um dos nossos nove programas de prémios inclui centenas de categorias que reconhecem a excelência em todas as facetas da vida profissional.
    cards:
      - logo:
        ...
        description: Os International Business Awards estão abertos a todas as organizações a nível mundial e incluem categorias destinadas a reconhecer as realizações em todos os aspetos da vida profissional.
      ...
      - logo:
        ...
        description: Os Prémios Stevie para Excelentes Empregadores estão abertos a todas as organizações a nível mundial e distinguem as melhores empresas do mundo para se trabalhar, bem como as equipas e os profissionais de RH, as conquistas na área dos recursos humanos, os novos produtos e serviços e os fornecedores que contribuem para criar e promover excelentes locais de trabalho.
      ...
      - logo:
        ...
        description: Os Prémios Stevie de Excelência Tecnológica celebram as realizações notáveis de indivíduos, equipas e organizações que estão a moldar o futuro da tecnologia em todos os setores da indústria. Podem candidatar-se indivíduos e organizações de todo o mundo — públicas e privadas, com ou sem fins lucrativos, grandes e pequenas.
      ...
      - logo:
        ...
        description: Os Prémios Stevie para Vendas e Atendimento ao Cliente estão abertos a todas as organizações a nível mundial e reconhecem as conquistas dos profissionais das áreas de vendas, atendimento ao cliente e centros de atendimento.
      ...
      - logo:
        ...
        description: Todas as organizações sediadas nos EUA podem participar no principal programa de prémios empresariais dos EUA.
      ...
      - logo:
        ...
        description: Os Prémios Stevie da Ásia-Pacífico estão abertos a todas as organizações dos 29 mercados da região da Ásia-Pacífico.
      ...
      - logo:
        ...
        description: Os Prémios Stevie do Médio Oriente e Norte de África reconhecem a inovação no local de trabalho em organizações de todos os tipos, em 18 países da região MENA.
      ...
      - logo:
        ...
        description: 'Os German Stevie Awards estão abertos a todas as organizações dos países europeus onde o alemão é língua oficial: Áustria, Bélgica, Alemanha, Liechtenstein, Luxemburgo e Suíça.'
