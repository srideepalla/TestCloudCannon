---
title: 'Obtenga el kit de inscripción: su guía para enviar nominaciones'
pageSections:
  - _component: page-sections/features/split-list-form
    ...
    subheading: ''
    heading: ''
    formHeading: Consigue tu kit de inscripción
    formEmbed: >-
    ...
    description: |+
      Solicite gratis el kit de inscripción de los International Business Awards
      y reciba la guía completa con plazos, categorías y consejos para preparar
    ...
    buttonSections:
      - _component: building-blocks/core-elements/button
        text: >-
          Volver a la página principal de los Premios Internacionales de
          Negocios
        link: /
        variant: secondary
        uppercase: false
