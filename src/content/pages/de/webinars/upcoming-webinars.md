---
_schema: default
title: Frauen | Zukünftige Webinare
description: Nehmen Sie an drei inspirierenden Webinaren teil, die im Juni, Juli und August 2026 stattfinden – sie sollen Frauen in der Geschäftswelt stärken, vernetzen und fördern.
pageSections:
  - _component: page-sections/heroes/hero-banner
    ...
    text: |-
      ...
      <a href="https://events.zoom.us/ev/AlP-HrRRp0dR0uu05YHymaoLNSYLxlq9ckutuv4PyM2S_LWuS8Ky~Anhwl_XeGoxbqDQLrOMecileFZV6OnX5XNI3cFs6DNLD49fgspD5CbpivA" target="_blank" rel="noopener" title="Jetzt registrieren"><strong>Jetzt registrieren</strong></a>
    colorScheme: light
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 17. Juni 2026, 14:00 Uhr EDT
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 15. Juli 2026, 14:00 Uhr EDT
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 12. August 2026, 14:00 Uhr EDT
                level: h3
                size: md
                alignX: start
                iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: 'Sind Sie in der APAC-Region ansässig? Melden Sie sich für diese AEST-freundlichen Veranstaltungen an, damit Sie live dabei sein können:'
        level: h1
        size: md
        alignX: center
        iconPosition: before
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 17. Juni 2026, 14:00 Uhr AEST
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 15. Juli 2026, 14:00 Uhr AEST
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 12. August 2026, 14:00 Uhr AEST
                level: h3
                size: md
                alignX: start
                iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: Warum registrieren?
        level: h2
        size: xl
        alignX: start
        iconPosition: before
      - _component: building-blocks/core-elements/text
        text: Die Teilnehmerinnen erhalten praktische Tipps von anderen erfolgreichen Unternehmerinnen und mit dem Stevie Award ausgezeichneten weiblichen Führungskräften zu Themen wie dem Aufbau, der Führung oder der Gründung eines erfolgreichen Unternehmens, dem Nutzen der Teilnahme an Unternehmenswettbewerben und dem Einsatz von Storytelling-Techniken, um sich von der Konkurrenz abzuheben. Lernen Sie von den Frauen, die es am besten können, entdecken Sie neue Möglichkeiten und **gestalten Sie Ihre Zukunft!**
        alignX: start
    maxContentWidth: 2xl
    paddingHorizontal: 2xl
    paddingVertical: xl
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: Für wen sind die Webinare gedacht?
        level: h2
        size: xl
        alignX: start
        iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: Unsere Mission und unser Slogan
        level: h2
        size: xl
        alignX: start
        iconPosition: before
  ...
  - _component: page-sections/features/split-list-form
    ...
    backgroundColor: base
  - _component: page-sections/features/split-list-form
    subheading: Bleiben Sie auf dem Laufenden
    heading: Tragen Sie sich in unseren Newsletter ein
    description: Geben Sie unten Ihre Daten ein, dann senden wir Ihnen per E-Mail wichtige Informationen zur Webinar-Reihe zu.
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/features/split-list-form
    subheading: Kontakt
    heading: Kontakt
    description: Haben Sie Fragen zu den „Women\|Future“-Webinaren? Schreiben Sie uns eine Nachricht, und ein Mitglied unseres Teams wird sich bei Ihnen melden.
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/text
        text: '**Folgen Sie uns!** Wir veröffentlichen die neuesten Updates auf unseren Social-Media-Seiten und in unserem Blog.'
        alignX: center
