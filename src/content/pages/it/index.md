---
_schema: default
title: Gli Stevie® Awards per le donne nel mondo degli affari
description: ''
pageSections:
  - _component: page-sections/heroes/hero-calendar
    ...
    buttonSections:
      - _component: building-blocks/core-elements/button
        text: Richiedi il tuo kit di iscrizione
        hideText: false
        ...
        size: md
      - _component: building-blocks/core-elements/button
        text: Pronti? Partecipate subito
        hideText: false
  ...
  - _component: page-sections/features/split-list-form
    subheading: Segnalate aziende gestite da donne, imprenditrici e altro ancora
    heading: Categorie dei premi
    description: |-
      Da oltre 20 anni, gli Stevie® Awards for Women in Business puntano i riflettori sulle donne e sulle organizzazioni di ogni tipo e dimensione in tutto il mondo, gestite o guidate da donne: grandi e piccole, pubbliche e private, a scopo di lucro e senza scopo di lucro. L'edizione 2025 del concorso ha attirato oltre 1.500 candidature provenienti da 48 nazioni.

      Possono essere candidate imprenditrici, dirigenti, dipendenti e le organizzazioni da loro gestite in tutto il mondo. Con oltre 200 categorie che coprono un'ampia gamma di risultati sul posto di lavoro, è possibile presentare candidature che mettano in evidenza il proprio impatto e i propri valori unici. Il programma del 2026 introduce nuove categorie che riconoscono i risultati ottenuti nell'ambito dell'intelligenza artificiale e della tecnologia.
    list:
      _component: building-blocks/core-elements/list
      items:
        - text: Categorie di risultati
          iconName: four-pointed-star
          iconColor: brand
        - text: Risultati ottenuti nelle categorie Comunicazione, Marketing o Relazioni pubbliche
          iconName: four-pointed-star
          iconColor: brand
        - text: Intelligenza artificiale (IA) e categorie tecnologiche (Novità per il 2026)
          iconName: four-pointed-star
          iconColor: brand
        - text: Azienda/Organizzazione (di proprietà o guidata da donne) – Categorie dei premi
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorie dei premi individuali femminili
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorie dei premi Media (sviluppati per/da donne)
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorie dei premi per nuovi prodotti e servizi (sviluppati per/da donne)
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorie dei social media
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorie di sostenibilità
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorie di leadership di pensiero
          iconName: four-pointed-star
          iconColor: brand
      listType: icon
      direction: vertical
    ...
    buttonSections:
      - _component: building-blocks/core-elements/button
        text: Visualizza tutte le categorie
        hideText: false
  ...
  - _component: page-sections/features/feature-logo-scroller
    heading: Vincitrici delle passate edizioni degli Stevie® Awards for Women in Business
    description: 'Ogni anno vengono premiate le titolari di piccole imprese e le imprenditrici, insieme a donne dirigenti di multinazionali quali IBM, Mastercard e Microsoft. Tra le vincitrici delle edizioni precedenti figurano:'
    logos:
    ...
    backgroundColor: base
  - _component: page-sections/features/split-list-form
    subheading: Gli Stevie® Awards per le donne nel mondo degli affari
    heading: ARTICOLI IN PRIMO PIANO
    description: ''
    list:
      ...
      stories:
        - image:
          ...
          title: Annunciati i vincitori della 22ª edizione degli Stevie® Awards per le donne nel mondo degli affari
        ...
        - image:
          ...
          title: Annunciati i finalisti dei premi SheShapesAI di Persistent in occasione della 22ª edizione degli Stevie® Awards for Women in Business
        ...
        - image:
          ...
          title: Iscriviti ai webinar Women|Future 2026
  ...
  - _component: page-sections/features/grid-videos
    heading: Cosa significa vincere uno Stevie Award per i nostri vincitori del 2025
    videos:
  ...
  - _component: page-sections/features/grid-testimonials
    heading: Testimonianze dei vincitori
    testimonials:
  ...
  - _component: page-sections/carousels/gallery-carousel
    heading: Galleria degli eventi 2025
    description: |-
  ...
  - _component: page-sections/carousels/card-carousel
    heading: Scopri gli altri concorsi degli Stevie® Awards
    description: Qualunque sia il motivo per cui la tua organizzazione desidera ottenere un riconoscimento, esiste un programma e una categoria degli Stevie Awards adatti alle tue esigenze. Dai singoli professionisti e dai team ai reparti e ai risultati a livello aziendale, ciascuno dei nostri nove programmi di premiazione comprende centinaia di categorie che riconoscono l'eccellenza in ogni aspetto della vita lavorativa.
    cards:
      - logo:
        ...
        description: Gli International Business Awards sono aperti a tutte le organizzazioni del mondo e comprendono categorie volte a premiare i risultati raggiunti in tutti gli ambiti della vita lavorativa.
      ...
      - logo:
        ...
        description: Gli Stevie Awards for Great Employers sono aperti a tutte le organizzazioni del mondo e premiano le migliori aziende al mondo in cui lavorare, i team e i professionisti delle risorse umane, i risultati ottenuti in questo settore, i nuovi prodotti e servizi, nonché i fornitori che contribuiscono a creare e promuovere ambienti di lavoro eccellenti.
      ...
      - logo:
        ...
        description: Tutte le organizzazioni con sede negli Stati Uniti possono partecipare al più prestigioso programma di premi aziendali degli Stati Uniti.
      ...
      - logo:
        ...
        description: Gli Stevie Awards per il Medio Oriente e il Nord Africa premiano l'innovazione sul posto di lavoro in organizzazioni di ogni tipo in 18 paesi della regione MENA.
      ...
      - logo:
        ...
        description: 'Gli Stevie Awards tedeschi sono aperti a tutte le organizzazioni dei paesi europei in cui il tedesco è lingua ufficiale: Austria, Belgio, Germania, Liechtenstein, Lussemburgo e Svizzera.'
