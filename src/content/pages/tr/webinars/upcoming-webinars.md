...
pageSections:
  - _component: page-sections/heroes/hero-banner
    ...
    text: |-
      ...
      <a href="https://events.zoom.us/ev/AlP-HrRRp0dR0uu05YHymaoLNSYLxlq9ckutuv4PyM2S_LWuS8Ky~Anhwl_XeGoxbqDQLrOMecileFZV6OnX5XNI3cFs6DNLD49fgspD5CbpivA" target="_blank" rel="noopener" title="Şimdi Kaydolun"><strong>Şimdi Kaydolun</strong></a>
    colorScheme: light
      ...
      - _component: building-blocks/core-elements/text
        text: |-
          ...
          **Şimdi kaydolun ve kuruluşunuzu büyütmenize ve geleceğe hazırlamanıza, iş ödülleri aracılığıyla güvenilirlik kazanmanıza ve işlerini başarıyla kurup büyütmüş kadın girişimcilerin ilk elden bakış açılarını öğrenmenize yardımcı olacak pratik stratejileri keşfedin!**
          ...
          #### <a href="https://events.zoom.us/eo/Ar4HyDfsTUwExQwZVUZkEKEaQesL1k89yilL_2l6qdF2QITSLcF4~AggLXsr32QYFjq8BlYLZ5I06Dg" target="_blank" rel="noopener" title="Şimdi Kaydolun"><strong>Şimdi Kaydolun</strong></a>
        alignX: center
    maxContentWidth: 2xl
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 17 Haziran 2026, 14:00 (EDT)
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 12 Ağustos 2026, 14:00 (EDT)
                level: h3
                size: md
                alignX: start
                iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: 'APAC bölgesinde mi bulunuyorsunuz? Canlı olarak katılabilmek için AEST saat dilimine uygun bu oturumlara kaydolun:'
        level: h1
        size: md
        alignX: center
        iconPosition: before
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 17 Haziran 2026, 14:00 AEST
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 15 Temmuz 2026, 14:00 AEST
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 12 Ağustos 2026, 14:00 (AEST)
                level: h3
                size: md
                alignX: start
                iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: Web seminerleri kimler içindir?
        level: h2
        size: xl
        alignX: start
        iconPosition: before
  ...
  - _component: page-sections/features/split-list-form
    subheading: Bizimle İşbirliği Yapın
    heading: Ortaklık Talepleri
    description: Markanızın küresel kadın profesyonel topluluğu nezdindeki görünürlüğünü artırın! Sponsorlar, web sitemiz, sosyal medya hesaplarımız ve e-postalarımızda öne çıkarılır; ayrıca dünya çapında yüzlerce iş lideri ve girişimcinin katıldığı web seminerlerimizde de görünürlük kazanır. 2026 sponsorluk fırsatları hakkında bilgi almak için [Lindsey@stevieawards.com](mailto:Lindsey@stevieawards.com) adresine e-posta gönderin veya aşağıdaki formu doldurun.
    list:
  ...
  - _component: page-sections/features/split-list-form
    ...
    heading: Bize Ulaşın
    description: Women\|Future Web Seminerleri hakkında sorularınız mı var? Bize bir mesaj gönderin, ekibimizden bir üye size geri dönüş yapacaktır.
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/text
        text: '**Bizi takip edin!** En son gelişmeleri sosyal medya sayfalarımızda ve blogumuzda paylaşıyoruz.'
        alignX: center
  ...
  - _component: page-sections/builders/custom-section
    ...
    brandColorOverride: ''
    useDefaultEditableBinding: true
pageHeading: Çevrimiçi seminerler
