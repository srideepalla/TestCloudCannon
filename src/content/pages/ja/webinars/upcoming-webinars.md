...
pageSections:
  - _component: page-sections/heroes/hero-banner
    ...
    text: |-
      「2026年スティービー®・アワード・フォー・ウィメン・イン・ビジネス」に関する無料ライブウェビナーにご参加ください。ノミネートや審査のプロセス、今年の新たな取り組み、そして審査員に対してご自身の功績を最大限にアピールするための成功事例の書き方に関するヒントをご紹介します。 また、ご自身の功績に最適な部門の選び方に関するアドバイスも提供されます。さらに、ライブQ&Aセッションでは、スティービー・アワード創設者のマイケル・ギャラガー氏に直接質問する機会も設けられています。

      ###### **2026年6月18日 午前11:00～午後12:00（米国東部時間）ライブ配信<br/>「2026年スティービー®・アワード・フォー・ウィメン・イン・ビジネス」受賞戦略**

      <a href="https://events.zoom.us/ev/AlP-HrRRp0dR0uu05YHymaoLNSYLxlq9ckutuv4PyM2S_LWuS8Ky~Anhwl_XeGoxbqDQLrOMecileFZV6OnX5XNI3cFs6DNLD49fgspD5CbpivA" target="_blank" rel="noopener" title="今すぐ登録"><strong>今すぐ登録</strong></a>
    colorScheme: light
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: 参加を希望するウェビナーごとに、個別に登録してください：
        level: h1
        size: md
        alignX: center
        iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: APAC地域にお住まいですか？AEST（オーストラリア東部標準時）に合わせて開催される以下のセッションにご登録いただき、ライブ配信にご参加ください：
        level: h1
        size: md
        alignX: center
        iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: このウェビナーはどのような方を対象としていますか？
        level: h2
        size: xl
        alignX: start
        iconPosition: before
      - _component: building-blocks/core-elements/text
        text: 当社のウェビナーは、業界やキャリアの段階を問わず、意欲的で先見の明のある女性プロフェッショナルを対象としています。世界中の意欲的な女性たちが、成功を収めた事業主や起業家から、最も重要なトピックについて新たな視点を得るために、このウェビナーに参加しています。 参加者は、CEO、創業者、中小企業経営者、起業家、幹部、取締役、マネージャーに加え、転職活動中の方やキャリアチェンジを始めようとしている女性など、多岐にわたります。
        alignX: start
    maxContentWidth: 2xl
    paddingHorizontal: 2xl
    paddingVertical: xl
  ...
  - _component: page-sections/features/split-list-form
    ...
    backgroundColor: base
  - _component: page-sections/features/split-list-form
    subheading: 最新情報をチェック
    heading: メーリングリストにご登録ください
    description: 以下のフォームに必要事項をご入力ください。ウェビナーシリーズに関する重要な最新情報をメールでお送りします。
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/features/split-list-form
    subheading: お問い合わせ
    heading: お問い合わせ
    description: 「Women\|Future」ウェビナーについてご質問がありますか？メッセージをお送りいただければ、担当者より折り返しご連絡いたします。
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/text
        text: '**フォローをお願いします！** ソーシャルメディアやブログでは、最新情報を随時更新しています。'
        alignX: center
