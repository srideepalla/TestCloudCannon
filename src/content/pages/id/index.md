---
_schema: default
title: Penghargaan Stevie® untuk Wanita di Dunia Bisnis
description: ''
pageSections:
  - _component: page-sections/heroes/hero-calendar
    ...
    buttonSections:
      - _component: building-blocks/core-elements/button
        text: Ajukan Permohonan Paket Pendaftaran Anda
        hideText: false
  ...
  - _component: page-sections/features/split-list-form
    subheading: Ajukan Usulan untuk Usaha Milik Perempuan, Pengusaha Perempuan, dan Lainnya
    heading: Kategori Penghargaan
    description: |-
      Selama lebih dari 20 tahun, Stevie® Awards for Women in Business telah menyoroti para perempuan serta organisasi yang dimiliki dan dipimpin oleh perempuan dari segala jenis dan skala di seluruh dunia: baik yang besar maupun kecil, milik pemerintah maupun swasta, serta yang berorientasi laba maupun nirlaba. Kompetisi tahun 2025 ini menarik lebih dari 1.500 nominasi dari 48 negara.

      Pengusaha wanita, eksekutif, karyawan, dan organisasi yang mereka pimpin di seluruh dunia berhak untuk dinominasikan. Dengan lebih dari 200 kategori yang mencakup berbagai pencapaian di tempat kerja, Anda dapat mengajukan nominasi yang menonjolkan dampak dan nilai-nilai unik Anda. Program tahun 2026 memperkenalkan kategori baru yang mengakui pencapaian di bidang kecerdasan buatan dan teknologi.
    list:
      ...
      items:
        - text: Kategori Prestasi
          ...
          iconColor: brand
        - text: Prestasi dalam Kategori Komunikasi, Pemasaran, atau Hubungan Masyarakat
          iconName: four-pointed-star
          iconColor: brand
        - text: Kecerdasan Buatan (AI) dan Kategori Teknologi (Baru untuk Tahun 2026)
          iconName: four-pointed-star
          iconColor: brand
        - text: Kategori Penghargaan Perusahaan/Organisasi (Yang Dimiliki atau Dipimpin oleh Perempuan)
          iconName: four-pointed-star
          iconColor: brand
        - text: Kategori Penghargaan Perorangan Wanita
          iconName: four-pointed-star
          iconColor: brand
        - text: Kategori Penghargaan Media (Yang Dikembangkan untuk/oleh Perempuan)
          iconName: four-pointed-star
          iconColor: brand
        - text: Kategori Penghargaan Produk & Layanan Baru (Yang Dikembangkan untuk/oleh Perempuan)
          iconName: four-pointed-star
          iconColor: brand
        - text: Kategori Media Sosial
          iconName: four-pointed-star
          iconColor: brand
        - text: Kategori Keberlanjutan
          iconName: four-pointed-star
          iconColor: brand
        - text: Kategori Pemikiran Terdepan
          iconName: four-pointed-star
          iconColor: brand
      listType: icon
      direction: vertical
  ...
  - _component: page-sections/features/feature-logo-scroller
    heading: Pemenang Sebelumnya dalam Penghargaan Stevie® untuk Wanita dalam Bisnis
    description: 'Setiap tahun, para pemilik usaha kecil dan wirausahawan perempuan mendapat pengakuan bersama para eksekutif perempuan dari perusahaan multinasional seperti IBM, Mastercard, dan Microsoft. Para pemenang sebelumnya antara lain:'
    logos:
    ...
    backgroundColor: base
  - _component: page-sections/features/split-list-form
    subheading: Penghargaan Stevie® untuk Wanita di Dunia Bisnis
    heading: ARTIKEL UTAMA
    description: ''
    list:
      ...
      stories:
        ...
        - image:
          ...
          title: Diumumkan Para Finalis Penghargaan SheShapesAI dari Persistent pada Acara Penghargaan Stevie® Tahunan ke-22 untuk Wanita dalam Bisnis
  ...
  - _component: page-sections/features/grid-videos
    heading: Apa Artinya Memenangkan Penghargaan Stevie bagi Para Pemenang Tahun 2025 Kami
    videos:
      - youtubeId: UqX5Q9pE6io
        title: 'Merek Distruptor meraih penghargaan dalam ajang Stevie® Awards for Women in Business 2025 '
      - youtubeId: wvSEt0yvIqs
        title: Green Panther Skincare meraih penghargaan dalam ajang Stevie® Awards for Women in Business 2025
      - youtubeId: fS5Q7wiWcJs
        title: Clearpath Learning Group meraih penghargaan dalam ajang Stevie® Awards for Women in Business 2025
    colorScheme: light
    backgroundColor: base
  - _component: page-sections/features/grid-testimonials
    heading: Kesaksian Para Pemenang
    testimonials:
  ...
  - _component: page-sections/carousels/card-carousel
    heading: Jelajahi Kompetisi Stevie® Awards Lainnya
    description: Apa pun yang ingin diakui oleh organisasi Anda, pasti ada program dan kategori Stevie Awards yang sesuai. Mulai dari profesional individu dan tim hingga departemen dan pencapaian di tingkat perusahaan, masing-masing dari sembilan program penghargaan kami mencakup ratusan kategori yang menghargai keunggulan di setiap aspek kehidupan kerja.
    cards:
      - logo:
        ...
        description: Penghargaan Bisnis Internasional terbuka bagi semua organisasi di seluruh dunia, dan mencakup berbagai kategori untuk menghargai prestasi di segala aspek kehidupan kerja.
      ...
      - logo:
        ...
        description: Penghargaan Stevie untuk Penjualan & Layanan Pelanggan terbuka bagi semua organisasi di seluruh dunia, dan memberikan pengakuan atas prestasi para profesional di bidang penjualan, layanan pelanggan, dan pusat panggilan.
      ...
      - logo:
        ...
        description: Asia-Pacific Stevie Awards terbuka bagi semua organisasi di 29 pasar di kawasan Asia-Pasifik.
      ...
      - logo:
        ...
        description: Penghargaan Stevie untuk Timur Tengah dan Afrika Utara memberikan pengakuan atas inovasi di tempat kerja pada berbagai jenis organisasi di 18 negara di kawasan MENA.
      ...
      - logo:
        ...
        description: 'German Stevie Awards terbuka bagi semua organisasi di negara-negara Eropa yang menggunakan bahasa Jerman sebagai bahasa resmi: Austria, Belgia, Jerman, Liechtenstein, Luksemburg, dan Swiss.'
