---
_schema: default
title: Wanita|Webinar Mendatang
description: Bergabunglah bersama kami dalam tiga webinar inspiratif yang akan diselenggarakan pada bulan Juni, Juli, dan Agustus 2026 — yang dirancang untuk memberdayakan, menjalin koneksi, dan mengangkat peran perempuan di dunia bisnis.
pageSections:
  - _component: page-sections/heroes/hero-banner
    ...
    text: |-
      ...
      <a href="https://events.zoom.us/ev/AlP-HrRRp0dR0uu05YHymaoLNSYLxlq9ckutuv4PyM2S_LWuS8Ky~Anhwl_XeGoxbqDQLrOMecileFZV6OnX5XNI3cFs6DNLD49fgspD5CbpivA" target="_blank" rel="noopener" title="Daftar Sekarang"><strong>Daftar Sekarang</strong></a>
    colorScheme: light
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: 'Daftarkan diri Anda secara terpisah untuk setiap webinar yang ingin Anda ikuti:'
        level: h1
        size: md
        alignX: center
        iconPosition: before
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 17 Juni 2026, pukul 14.00 EDT
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 15 Juli 2026, pukul 14.00 EDT
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 12 Agustus 2026, pukul 14.00 EDT
                level: h3
                size: md
                alignX: start
                iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: 'Apakah Anda berada di kawasan APAC? Daftarkan diri Anda untuk sesi-sesi yang disesuaikan dengan zona waktu AEST ini agar Anda dapat mengikuti secara langsung:'
        level: h1
        size: md
        alignX: center
        iconPosition: before
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 17 Juni 2026, pukul 14.00 AEST
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 15 Juli 2026, pukul 14.00 AEST
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 12 Agustus 2026, pukul 14.00 AEST
                level: h3
                size: md
                alignX: start
                iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: Mengapa Harus Mendaftar?
        level: h2
        size: xl
        alignX: start
        iconPosition: before
      - _component: building-blocks/core-elements/text
        text: Para peserta akan mendapatkan wawasan praktis dari para pengusaha sukses dan pemimpin bisnis wanita peraih Stevie Award mengenai berbagai topik, termasuk cara mengembangkan, mempertahankan, atau memulai bisnis yang sukses, manfaat mengikuti ajang penghargaan bisnis, serta cara memanfaatkan teknik bercerita untuk membedakan bisnis Anda dari pesaing. Belajarlah dari para wanita yang paling ahli di bidangnya, temukan peluang-peluang baru, dan **Bangun Masa Depan Anda!**
        alignX: start
    maxContentWidth: 2xl
    paddingHorizontal: 2xl
    paddingVertical: xl
  ...
  - _component: page-sections/features/split-list-form
    subheading: Bergabunglah dengan Kami
    heading: Pertanyaan Mengenai Kemitraan
    description: Tingkatkan eksposur merek Anda kepada komunitas profesional wanita di seluruh dunia! Para sponsor akan ditampilkan secara menonjol di situs web, media sosial, dan email kami, serta mendapatkan visibilitas selama webinar kami yang dihadiri oleh ratusan pemimpin bisnis dan wirausahawan dari seluruh dunia. Kirim email ke [Lindsey@stevieawards.com](mailto:Lindsey@stevieawards.com) untuk informasi mengenai peluang sponsor tahun 2026, atau isi formulir di bawah ini.
    list:
    ...
    backgroundColor: base
  - _component: page-sections/features/split-list-form
    subheading: Tetap Terkini
    heading: Bergabunglah dengan Daftar Email Kami
    description: Isi informasi Anda di bawah ini, dan kami akan mengirimkan pembaruan penting melalui email mengenai rangkaian webinar ini.
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/features/split-list-form
    ...
    description: Ada pertanyaan tentang webinar Women\|Future? Kirimkan pesan kepada kami, dan salah satu anggota tim kami akan segera menghubungi Anda.
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/text
        text: '**Ikuti Kami!** Kami membagikan kabar terbaru di halaman media sosial dan blog kami.'
        alignX: center
