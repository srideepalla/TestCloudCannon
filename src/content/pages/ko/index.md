...
pageSections:
    ...
    list:
      ...
      items:
        ...
        - text: 여성 개인 부문
          iconName: four-pointed-star
          iconColor: brand
        - text: 미디어 (여성을 위해/여성이 제작한) 어워드 부문
          iconName: four-pointed-star
          iconColor: brand
        - text: 여성 대상/여성이 개발한 신제품 및 서비스 부문
          iconName: four-pointed-star
          iconColor: brand
        - text: 소셜 미디어 카테고리
          iconName: four-pointed-star
  ...
  - _component: page-sections/features/feature-logo-scroller
    heading: 스티비® 여성 기업인 어워드의 역대 수상자
    description: '매년 여성 소상공인 및 창업가들이 IBM, 마스터카드, 마이크로소프트와 같은 글로벌 기업의 여성 임원들과 함께 그 공로를 인정받고 있습니다. 지난 수상자 명단은 다음과 같습니다:'
    logos:
    ...
    list:
      ...
      stories:
        - image:
          ...
          title: 제22회 연례 스티비® 여성 기업인 어워드 수상자 발표
        ...
        - image:
          ...
          title: 제22회 연례 스티비® 여성 기업인 대상(Stevie® Awards for Women in Business)에서 퍼시스턴트(Persistent)의 ‘SheShapesAI 어워드’ 최종 후보 발표
        ...
        - image:
          ...
          title: 2026 Women|Future 웨비나 등록하기
  ...
  - _component: page-sections/features/grid-videos
    heading: 2025년 스티비 어워드 수상자들에게 이 상이 갖는 의미
    videos:
      - youtubeId: UqX5Q9pE6io
        title: '디스트럽터 브랜드, 2025 스티비® 어워드 ‘여성 기업인 부문’에서 수상 '
      - youtubeId: wvSEt0yvIqs
        title: 그린 팬서 스킨케어, 2025 스티비® 어워드 ‘여성 기업인 부문’에서 수상
      - youtubeId: fS5Q7wiWcJs
        title: 클리어패스 러닝 그룹, 2025 스티비® 어워드 ‘여성 기업인 부문’에서 수상
    colorScheme: light
    backgroundColor: base
  ...
  - _component: page-sections/carousels/card-carousel
    heading: 다른 스티비® 어워드 공모전 살펴보기
    description: 귀사의 조직이 어떤 분야에서 인정을 받고자 하든, 그에 걸맞은 스티비 어워드(Stevie Awards) 프로그램과 부문이 마련되어 있습니다. 개인 전문가와 팀부터 부서 및 전사적 성과에 이르기까지, 총 9개의 어워드 프로그램 각각은 업무 생활의 모든 측면에서 탁월함을 인정하는 수백 개의 부문을 갖추고 있습니다.
    cards:
      - logo:
        ...
        description: ‘국제 비즈니스 어워드(International Business Awards)’는 전 세계 모든 조직이 참가할 수 있으며, 업무 생활의 모든 측면에서 이룬 성과를 기리는 다양한 부문을 포함하고 있습니다.
      ...
      - logo:
        ...
        description: ‘스티비 기술 우수상(Stevie Awards for Technology Excellence)’은 모든 산업 분야에서 기술의 미래를 선도하는 개인, 팀 및 조직의 탁월한 성과를 기리는 시상식입니다. 전 세계의 개인과 조직이라면 누구나 참가할 수 있으며, 공공 및 민간, 영리 및 비영리, 대기업 및 중소기업을 불문합니다.
      ...
      - logo:
        ...
        description: 미국에 본사를 둔 모든 조직은 미국 최고의 비즈니스 시상식에 참가할 자격이 있습니다.
      ...
      - logo:
        ...
        description: 아시아-태평양 스티비 어워드는 아시아-태평양 지역 29개 시장의 모든 기관이 참가할 수 있습니다.
      ...
      - logo:
        ...
        description: 독일 스티비 어워드는 독일어가 공용어인 유럽 국가(오스트리아, 벨기에, 독일, 리히텐슈타인, 룩셈부르크, 스위스)의 모든 기관이 참가할 수 있습니다.
