...
pageSections:
  - _component: page-sections/heroes/hero-banner
    ...
    text: |-
      2026 스티비® 여성 기업인 어워즈(Stevie® Awards for Women in Business)에 관한 무료 라이브 웨비나에 참여하여, 후보 추천 및 심사 절차, 올해의 새로운 변화, 그리고 심사위원들에게 여러분의 성과를 가장 효과적으로 어필할 수 있는 성공 스토리를 작성하는 방법에 대한 팁을 확인해 보세요. 또한, 여러분의 성과에 적합한 부문을 선정하는 방법에 대한 안내를 받으실 수 있으며, 실시간 질의응답 시간을 통해 스티비 어워즈(Stevie Awards) 창립자 마이클 갤러거(Michael Gallagher)에게 직접 질문할 기회도 얻으실 수 있습니다.

      ###### **2026년 6월 18일 오전 11시 ~ 오후 12시 (미국 동부 표준시) 생중계<br/>2026 스티비® 여성 비즈니스 어워드(Stevie® Awards for Women in Business) 수상 전략**

      <a href="https://events.zoom.us/ev/AlP-HrRRp0dR0uu05YHymaoLNSYLxlq9ckutuv4PyM2S_LWuS8Ky~Anhwl_XeGoxbqDQLrOMecileFZV6OnX5XNI3cFs6DNLD49fgspD5CbpivA" target="_blank" rel="noopener" title="지금 등록하기"><strong>지금 등록하기</strong></a>
    colorScheme: light
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: '참석하고 싶은 웨비나마다 개별적으로 등록해 주세요:'
        level: h1
        size: md
        alignX: center
        iconPosition: before
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 2026년 6월 17일 오후 2시 (미국 동부 표준시)
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 2026년 7월 15일 오후 2시 (미국 동부 표준시)
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 2026년 8월 12일 오후 2시 (미국 동부 표준시)
                level: h3
                size: md
                alignX: start
                iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: '아시아태평양(APAC) 지역에 계신가요? AEST 시간대에 맞춰 진행되는 다음 세션에 등록하여 실시간으로 참여하세요:'
        level: h1
        size: md
        alignX: center
        iconPosition: before
  ...
  - _component: page-sections/features/split-list-form
    subheading: 파트너가 되어 주세요
    heading: 파트너십 문의
    description: 전 세계 여성 전문가 커뮤니티에 브랜드를 널리 알리세요! 후원사는 당사 웹사이트, 소셜 미디어, 이메일에서 소개되며, 전 세계 수백 명의 비즈니스 리더와 기업가가 참여하는 웨비나에서 브랜드를 홍보할 수 있는 기회를 얻게 됩니다. 2026년 후원 기회에 대해 문의하시려면 [Lindsey@stevieawards.com](mailto:Lindsey@stevieawards.com)으로 이메일을 보내주시거나, 아래 양식을 작성해 주십시오.
    list:
    ...
    backgroundColor: base
  - _component: page-sections/features/split-list-form
    subheading: 최신 소식을 놓치지 마세요
    heading: 메일링 리스트에 가입하세요
    description: 아래에 정보를 입력해 주시면, 웨비나 시리즈와 관련된 중요한 소식을 이메일로 보내드리겠습니다.
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/features/split-list-form
    subheading: 문의하기
    heading: 문의하기
    description: ‘Women\|Future’ 웨비나에 대해 궁금한 점이 있으신가요? 메시지를 보내주시면 저희 팀 담당자가 답변해 드리겠습니다.
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/text
        text: '**팔로우해 주세요!** 저희 소셜 미디어 페이지와 블로그에 최신 소식을 올리고 있습니다.'
        alignX: center
