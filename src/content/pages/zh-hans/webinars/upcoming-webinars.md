...
_schema: default
title: 女性|未来网络研讨会
description: 诚邀您参加将于2026年6月、7月和8月举行的三场鼓舞人心的网络研讨会——这些活动旨在赋能、联结并提升商界女性的发展。
pageSections:
  - _component: page-sections/heroes/hero-banner
    ...
    text: |-
      ...
      <a href="https://events.zoom.us/ev/AlP-HrRRp0dR0uu05YHymaoLNSYLxlq9ckutuv4PyM2S_LWuS8Ky~Anhwl_XeGoxbqDQLrOMecileFZV6OnX5XNI3cFs6DNLD49fgspD5CbpivA" target="_blank" rel="noopener" title="立即注册"><strong>立即注册</strong></a>
    colorScheme: light
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 2026年6月17日 下午2:00（澳大利亚东部标准时间）
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 2026年7月15日 下午2:00（澳大利亚东部标准时间）
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 2026年8月12日 下午2:00（澳大利亚东部标准时间）
                level: h3
                size: md
                alignX: start
                iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        ...
        iconPosition: before
      - _component: building-blocks/core-elements/text
        text: 我们的使命是通过举办现场教育讲座，促进女性在职业和个人层面的发展，从而激励并助力她们在商界取得成功。 “**开创你的明天**”是我们的口号。我们选择这一口号，是因为“Women|Future”系列网络研讨会不仅鼓励您拥抱未来，更希望您能从中获得灵感与前瞻性思维，从而实现职业、个人及生活层面的抱负。
        alignX: start
    maxContentWidth: 2xl
    paddingHorizontal: 2xl
    paddingVertical: xl
  ...
  - _component: page-sections/features/split-list-form
    subheading: 随时掌握最新动态
    heading: 加入我们的邮件列表
    description: 请在下方填写您的信息，我们将通过电子邮件向您发送有关该系列网络研讨会的重要更新。
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/features/split-list-form
    subheading: 联系我们
    heading: 联系我们
    description: 对“Women\|Future”网络研讨会还有疑问吗？请给我们发送消息，我们的团队成员将尽快与您联系。
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/text
        text: '**关注我们！** 我们会在社交媒体页面和博客上发布最新动态。'
        alignX: center
