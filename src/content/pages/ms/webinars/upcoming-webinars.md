...
pageSections:
  - _component: page-sections/heroes/hero-banner
    ...
    text: |-
      Sertailah webinar langsung percuma kami mengenai Anugerah Stevie® 2026 untuk Wanita dalam Perniagaan untuk mengetahui lebih lanjut tentang proses pencalonan dan penilaian, apa yang baharu tahun ini, dan petua untuk merangka kisah kejayaan yang mempersembahkan pencapaian anda kepada para hakim dengan cahaya paling terang. Anda juga akan mendapat panduan untuk memilih kategori yang sesuai bagi pencapaian anda dan berpeluang mengemukakan soalan secara langsung kepada Pengasas Stevie Awards, Michael Gallagher, semasa sesi soal jawab langsung.

      ###### **Siaran Langsung pada 18 Jun 2026, 11:00 pagi - 12:00 tengah hari (ET)<br />Strategi Menang untuk Anugerah Stevie® 2026 bagi Wanita dalam Perniagaan**

      <a href="https://events.zoom.us/ev/AlP-HrRRp0dR0uu05YHymaoLNSYLxlq9ckutuv4PyM2S_LWuS8Ky~Anhwl_XeGoxbqDQLrOMecileFZV6OnX5XNI3cFs6DNLD49fgspD5CbpivA" target="_blank" rel="noopener" title="Daftar Sekarang">Daftar Sekarang
    colorScheme: light
      ...
      - _component: building-blocks/core-elements/text
        text: |-
          ...
          **Daftar sekarang untuk menemui strategi praktikal yang membantu anda mengembangkan dan memastikan masa depan organisasi anda, membina kredibiliti melalui anugerah perniagaan, dan mendapatkan pandangan langsung daripada usahawan wanita yang telah berjaya membina dan mengembangkan perniagaan mereka!**
          ...
          #### <a href="https://events.zoom.us/eo/Ar4HyDfsTUwExQwZVUZkEKEaQesL1k89yilL_2l6qdF2QITSLcF4~AggLXsr32QYFjq8BlYLZ5I06Dg" target="_blank" rel="noopener" title="Daftar Sekarang">**Daftar Sekarang**
        alignX: center
    maxContentWidth: 2xl
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: 'Daftar secara individu untuk setiap webinar yang anda ingin hadiri:'
        level: h1
        size: md
        alignX: center
        iconPosition: before
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 17 Jun 2026, 2:00 petang EDT
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 15 Julai 2026, 2:00 petang EDT
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 12 Ogos 2026, 2:00 petang EDT
                level: h3
                size: md
                alignX: start
                iconPosition: before
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 17 Jun 2026, 2:00 petang AEST
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 15 Julai 2026, 2:00 petang AEST
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 12 Ogos 2026, 2:00 petang AEST
                level: h3
                size: md
                alignX: start
                iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: Siapa sasaran webinar ini?
        level: h2
        size: xl
        alignX: start
        iconPosition: before
      - _component: building-blocks/core-elements/text
        text: Webinar kami ditujukan kepada profesional wanita yang bercita-cita tinggi dan berfikiran jauh ke hadapan merentasi pelbagai industri dan peringkat kerjaya. Wanita bermotivasi tinggi di seluruh dunia menghadiri webinar ini untuk memperoleh perspektif baharu mengenai topik-topik penting daripada pemilik perniagaan dan usahawan yang berjaya. Para peserta terdiri daripada CEO, pengasas, pemilik perniagaan kecil, usahawan, eksekutif, pengarah, dan pengurus, serta wanita yang sedang mencari pekerjaan atau memulakan peralihan kerjaya.
        alignX: start
    maxContentWidth: 2xl
    paddingHorizontal: 2xl
    paddingVertical: xl
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: Misi dan Tagline Kami
        level: h2
        size: xl
        alignX: start
        iconPosition: before
      - _component: building-blocks/core-elements/text
        text: Misi kami adalah untuk memberi inspirasi dan mempercepat kemajuan wanita dalam perniagaan dengan memupuk pembangunan profesional dan peribadi melalui sesi pendidikan secara langsung. **Budayakan Masa Depan Anda** adalah slogan kami. Kami memilih frasa ini kerana webinar The Women|Future menggalakkan anda bukan sahaja untuk merangkul masa depan anda, tetapi juga untuk membawa pulang inspirasi dan kepimpinan pemikiran bagi menangani aspirasi kerjaya, peribadi, dan kehidupan anda.
        alignX: start
    maxContentWidth: 2xl
    paddingHorizontal: 2xl
    paddingVertical: xl
  ...
  - _component: page-sections/features/split-list-form
    subheading: Bekerjasama Dengan Kami
    heading: Permintaan Perkongsian
    description: Tingkatkan pendedahan jenama anda kepada komuniti profesional wanita global! Penaja akan diserlahkan di laman web kami, media sosial, emel, dan mendapat keterlihatan semasa webinar kami yang dihadiri oleh ratusan pemimpin perniagaan dan usahawan di seluruh dunia. E-mel [Lindsey@stevieawards.com](mailto:Lindsey@stevieawards.com) untuk peluang penajaan 2026, atau isi borang di bawah.
    list:
    ...
    backgroundColor: base
  - _component: page-sections/features/split-list-form
    subheading: Tetap di dalam gelung
    heading: Sertailah Senarai Mel Kami
    description: Isi maklumat anda di bawah, dan kami akan menghantar kemas kini e-mel penting mengenai siri webinar.
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/text
        text: Ikuti kami! Kami menyiarkan kemas kini terkini di halaman media sosial dan blog kami.
        alignX: center
