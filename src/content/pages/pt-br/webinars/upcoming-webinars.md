...
description: Junte-se a nós em três webinars inspiradores que acontecerão nos meses de junho, julho e agosto de 2026 — criados para empoderar, conectar e valorizar as mulheres no mundo dos negócios.
pageSections:
  - _component: page-sections/heroes/hero-banner
    heading: Webinar do Programa Stevie® Awards 2026 para Mulheres nos Negócios
    text: |-
      Participe do nosso webinar gratuito ao vivo sobre o Stevie® Awards for Women in Business 2026 para saber mais sobre os processos de indicação e avaliação, as novidades deste ano e dicas sobre como elaborar uma história de sucesso que apresente suas conquistas aos jurados da melhor maneira possível. Você também receberá orientações sobre como selecionar as categorias certas para suas conquistas e terá a oportunidade de fazer perguntas diretamente ao fundador do Stevie Awards, Michael Gallagher, durante uma sessão de perguntas e respostas ao vivo.

      ###### **Ao vivo em 18 de junho de 2026, das 11h às 12h (horário da costa leste dos EUA)<br/>Estratégias vencedoras para o Prêmio Stevie® 2026 para Mulheres nos Negócios**
      ...
      - _component: building-blocks/core-elements/text
        text: |-
          ...
          **Inscreva-se agora para descobrir estratégias práticas que ajudarão você a expandir e preparar sua organização para o futuro, construir credibilidade por meio de prêmios empresariais e obter perspectivas em primeira mão de mulheres empreendedoras que construíram e expandiram seus negócios com sucesso!**
          ...
          #### <a href="https://events.zoom.us/eo/Ar4HyDfsTUwExQwZVUZkEKEaQesL1k89yilL_2l6qdF2QITSLcF4~AggLXsr32QYFjq8BlYLZ5I06Dg" target="_blank" rel="noopener" title="Inscreva-se agora"><strong>Inscreva-se agora</strong></a>
        alignX: center
    maxContentWidth: 2xl
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: 'Inscreva-se individualmente em cada webinar do qual deseja participar:'
        level: h1
        size: md
        alignX: center
        iconPosition: before
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 17 de junho de 2026, 14h (horário da costa leste dos EUA)
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 15 de julho de 2026, 14h (horário da costa leste dos EUA)
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 12 de agosto de 2026, 14h (horário da costa leste dos EUA)
                level: h3
                size: md
                alignX: start
                iconPosition: before
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 17 de junho de 2026, 14h (AEST)
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 15 de julho de 2026, 14h (AEST)
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 12 de agosto de 2026, 14h (AEST)
                level: h3
                size: md
                alignX: start
                iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: Nossa missão e slogan
        level: h2
        size: xl
        alignX: start
        iconPosition: before
      - _component: building-blocks/core-elements/text
        text: Nossa missão é inspirar e impulsionar as mulheres no mundo dos negócios, promovendo o desenvolvimento profissional e pessoal por meio de sessões educacionais ao vivo. **Cultive o seu amanhã** é o nosso slogan. Escolhemos essa frase porque os webinars The Women\|Future incentivam você não apenas a abraçar o seu amanhã, mas também a sair com inspiração e liderança inovadora para enfrentar suas aspirações profissionais, pessoais e de vida.
        alignX: start
    maxContentWidth: 2xl
    paddingHorizontal: 2xl
    paddingVertical: xl
  ...
  - _component: page-sections/features/split-list-form
    ...
    description: Aumente a exposição da sua marca para uma comunidade global de mulheres profissionais! Os patrocinadores recebem destaque em nosso site, redes sociais e e-mails, além de visibilidade durante nossos webinars, que contam com a participação de centenas de líderes empresariais e empreendedoras em todo o mundo. Envie um e-mail para [Lindsey@stevieawards.com](mailto:Lindsey@stevieawards.com) para saber mais sobre as oportunidades de patrocínio para 2026 ou preencha o formulário abaixo.
    list:
    ...
    backgroundColor: base
  - _component: page-sections/features/split-list-form
    subheading: Fique por dentro das novidades
    heading: Inscreva-se na nossa lista de e-mails
    description: Preencha seus dados abaixo e enviaremos a você atualizações importantes por e-mail sobre a série de webinars.
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/features/split-list-form
    ...
    description: Tem alguma dúvida sobre os webinars Women\|Future? Envie-nos uma mensagem e um membro da nossa equipe entrará em contato com você.
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/text
        text: '**Siga-nos!** Publicamos as últimas novidades em nossas redes sociais e no nosso blog.'
        alignX: center
