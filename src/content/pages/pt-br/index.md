---
_schema: default
title: Prêmio Stevie® para Mulheres nos Negócios
description: ''
pageSections:
  - _component: page-sections/heroes/hero-calendar
    ...
    heading: 23ª edição do Prêmio Stevie® para Mulheres nos Negócios
    description: |-
      Reconhecendo a excelência em conquistas lideradas por mulheres em todos os setores. O Stevie® Awards for Women in Business é o principal prêmio empresarial do mundo que homenageia empreendedoras, executivas, funcionárias e as organizações que elas dirigem.

      Solicite hoje mesmo o seu kit de inscrição para saber como enviar as indicações. Junte-se ao panteão de ilustres vencedores do Prêmio Stevie®, como AT&T Business, Salesforce, It's a 10 e Watsons.
    buttonSections:
      - _component: building-blocks/core-elements/button
        text: Solicite seu kit de inscrição
        hideText: false
  ...
  - _component: page-sections/features/split-list-form
    subheading: Indique empresas de propriedade de mulheres, empreendedoras e muito mais
    heading: Categorias do prêmio
    description: |-
    ...
    list:
      ...
      items:
        ...
        - text: Categorias do Prêmio Mídia (Desenvolvido para/por Mulheres)
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorias do Prêmio de Novos Produtos e Serviços (Desenvolvidos para/por Mulheres)
          iconName: four-pointed-star
          iconColor: brand
        ...
        - text: Categorias de sustentabilidade
          iconName: four-pointed-star
          iconColor: brand
        - text: Categorias de Liderança em Ideias
          iconName: four-pointed-star
          iconColor: brand
      listType: icon
      direction: vertical
  ...
  - _component: page-sections/features/feature-logo-scroller
    heading: Vencedoras anteriores do Prêmio Stevie® para Mulheres nos Negócios
    description: 'Todos os anos, proprietárias de pequenas empresas e empreendedoras são homenageadas juntamente com executivas de corporações globais como a IBM, a Mastercard e a Microsoft. Entre as vencedoras de edições anteriores estão:'
    logos:
    ...
    backgroundColor: base
  - _component: page-sections/features/split-list-form
    subheading: Prêmio Stevie® para Mulheres nos Negócios
    heading: MATÉRIAS ESPECIAIS
    description: ''
    list:
      ...
      stories:
        - image:
          ...
          title: Anunciadas as vencedoras da 22ª edição do Prêmio Stevie® para Mulheres nos Negócios
        ...
        - image:
          ...
          title: Anunciados os finalistas do prêmio SheShapesAI da Persistent na 22ª edição do Stevie® Awards for Women in Business
        ...
        - image:
          ...
          title: Inscreva-se nos webinars Women|Future 2026
  ...
  - _component: page-sections/features/grid-videos
    heading: O que significa ganhar um Prêmio Stevie para os nossos vencedores de 2025
    videos:
      - youtubeId: UqX5Q9pE6io
        title: 'A marca Disruptor é premiada no Stevie® Awards 2025 para Mulheres nos Negócios '
      - youtubeId: wvSEt0yvIqs
        title: A Green Panther Skincare é premiada no Stevie® Awards 2025 para Mulheres nos Negócios
      - youtubeId: fS5Q7wiWcJs
        title: O Clearpath Learning Group é premiado no Stevie® Awards 2025 para Mulheres nos Negócios
    colorScheme: light
    backgroundColor: base
  - _component: page-sections/features/grid-testimonials
    heading: Depoimentos dos vencedores
    testimonials:
  ...
  - _component: page-sections/carousels/card-carousel
    ...
    cards:
      - logo:
        ...
        description: O International Business Awards está aberto a todas as organizações do mundo inteiro e inclui categorias destinadas a reconhecer realizações em todos os aspectos da vida profissional.
      ...
      - logo:
        ...
        description: O Prêmio Stevie para Grandes Empregadores está aberto a todas as organizações do mundo inteiro e reconhece as melhores empresas do mundo para se trabalhar, bem como as equipes e profissionais de RH, as conquistas na área de RH, novos produtos e serviços, e os fornecedores que ajudam a criar e promover excelentes ambientes de trabalho.
      ...
      - logo:
        ...
        description: O Prêmio Stevie de Excelência em Tecnologia celebra as realizações notáveis de indivíduos, equipes e organizações que estão moldando o futuro da tecnologia em todos os setores da indústria. Podem se inscrever indivíduos e organizações de todo o mundo — sejam elas públicas ou privadas, com ou sem fins lucrativos, grandes ou pequenas.
      ...
      - logo:
        ...
        description: O Prêmio Stevie de Vendas e Atendimento ao Cliente está aberto a todas as organizações do mundo inteiro e reconhece as conquistas dos profissionais das áreas de vendas, atendimento ao cliente e call center.
      ...
      - logo:
        ...
        description: Todas as organizações sediadas nos Estados Unidos podem participar do principal programa de prêmios empresariais dos EUA.
      ...
      - logo:
        ...
        description: O Prêmio Stevie da Ásia-Pacífico está aberto a todas as organizações dos 29 mercados da região da Ásia-Pacífico.
      ...
      - logo:
        ...
        description: O Prêmio Stevie do Oriente Médio e Norte da África reconhece a inovação no ambiente de trabalho em organizações de todos os tipos em 18 países da região MENA.
      ...
      - logo:
        ...
        description: 'O German Stevie Awards está aberto a todas as organizações dos países europeus nos quais o alemão é língua oficial: Áustria, Bélgica, Alemanha, Liechtenstein, Luxemburgo e Suíça.'
