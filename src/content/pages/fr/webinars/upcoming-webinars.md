---
_schema: default
title: Webinaires « Femmes | Avenir »
...
pageSections:
  - _component: page-sections/heroes/hero-banner
    ...
    text: |-
      ...
      <a href="https://events.zoom.us/ev/AlP-HrRRp0dR0uu05YHymaoLNSYLxlq9ckutuv4PyM2S_LWuS8Ky~Anhwl_XeGoxbqDQLrOMecileFZV6OnX5XNI3cFs6DNLD49fgspD5CbpivA" target="_blank" rel="noopener" title="S'inscrire maintenant"><strong>S'inscrire maintenant</strong></a>
    colorScheme: light
      ...
      - _component: building-blocks/core-elements/text
        text: |-
          ...
          **Inscrivez-vous dès maintenant pour découvrir des stratégies pratiques qui vous aideront à développer votre organisation et à la préparer pour l'avenir, à renforcer votre crédibilité grâce à des prix d'excellence, et à bénéficier des témoignages de femmes entrepreneurs qui ont réussi à créer et à développer leur entreprise !**
          ...
          #### <a href="https://events.zoom.us/eo/Ar4HyDfsTUwExQwZVUZkEKEaQesL1k89yilL_2l6qdF2QITSLcF4~AggLXsr32QYFjq8BlYLZ5I06Dg" target="_blank" rel="noopener" title="S'inscrire maintenant"><strong>S'inscrire maintenant</strong></a>
        alignX: center
    maxContentWidth: 2xl
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: 'Inscrivez-vous séparément à chaque webinaire auquel vous souhaitez participer :'
        level: h1
        size: md
        alignX: center
        iconPosition: before
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 17 juin 2026, 14 h 00 (heure de l'Est)
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 15 juillet 2026, 14 h 00 (heure de l'Est)
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 12 août 2026, 14 h 00 (heure de l'Est)
                level: h3
                size: md
                alignX: start
                iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: 'Vous résidez dans la région APAC ? Inscrivez-vous à ces sessions adaptées au fuseau horaire AEST afin de pouvoir y assister en direct :'
        level: h1
        size: md
        alignX: center
        iconPosition: before
        ...
        items:
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 17 juin 2026, 14 h 00 (heure de Sydney)
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 15 juillet 2026, 14 h 00 (heure de Sydney)
                level: h3
                size: md
                alignX: start
                iconPosition: before
          ...
          - contentSections:
              - _component: building-blocks/core-elements/image
                ...
                openInNewTab: true
              - _component: building-blocks/core-elements/heading
                text: 12 août 2026, 14 h 00 (heure de Sydney)
                level: h3
                size: md
                alignX: start
                iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        ...
        iconPosition: before
      - _component: building-blocks/core-elements/text
        text: Les participantes pourront s'inspirer des expériences concrètes d'autres entrepreneuses à succès et de femmes chefs d'entreprise lauréates des Stevie Awards sur des thèmes tels que la manière de développer, de pérenniser ou de créer une entreprise florissante, l'intérêt de participer à des concours d'entreprise, et comment utiliser les techniques de narration pour démarquer son entreprise de la concurrence. Apprenez auprès des femmes qui excellent dans ce domaine, ouvrez-vous à de nouvelles opportunités et **cultivez votre avenir !**
        alignX: start
    maxContentWidth: 2xl
    paddingHorizontal: 2xl
    paddingVertical: xl
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: À qui s'adressent ces webinaires ?
        level: h2
        size: xl
        alignX: start
        iconPosition: before
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: Notre mission et notre slogan
        level: h2
        size: xl
        alignX: start
        iconPosition: before
  ...
  - _component: page-sections/features/split-list-form
    subheading: Devenez notre partenaire
    heading: Demandes de partenariat
    description: Renforcez la visibilité de votre marque auprès d'une communauté internationale de femmes professionnelles ! Les sponsors bénéficient d'une mise en avant sur notre site web, nos réseaux sociaux et dans nos e-mails, ainsi que d'une grande visibilité lors de nos webinaires suivis par des centaines de chefs d'entreprise et d'entrepreneurs du monde entier. Envoyez un e-mail à [Lindsey@stevieawards.com](mailto:Lindsey@stevieawards.com) pour connaître les opportunités de parrainage pour 2026, ou remplissez le formulaire ci-dessous.
    list:
    ...
    backgroundColor: base
  - _component: page-sections/features/split-list-form
    subheading: Restez informé
    heading: Inscrivez-vous à notre liste de diffusion
    description: Remplissez le formulaire ci-dessous et nous vous enverrons par e-mail les dernières informations concernant cette série de webinaires.
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/features/split-list-form
    ...
    description: Vous avez des questions sur les webinaires Women\|Future ? Envoyez-nous un message et un membre de notre équipe vous répondra.
    list:
      _component: building-blocks/wrappers/article-link-list
      stories: []
    buttonSections: []
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      - _component: building-blocks/core-elements/text
        text: '**Suivez-nous !** Nous publions les dernières actualités sur nos réseaux sociaux et notre blog.'
        alignX: center
