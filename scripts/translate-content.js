...
const TRANSLATABLE_FIELDS = [
  ...
  'form_consent_text',
  'content_html'  // Added missing field
];
...
function preprocessHtmlForTranslation(html) {
  ...
  // For HTML content, we'll translate it as-is but DeepL handles HTML well
  // DeepL preserves HTML tags and only translates the text content
  return html;
}
